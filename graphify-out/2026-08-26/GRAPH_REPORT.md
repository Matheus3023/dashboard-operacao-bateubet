# Graph Report - dashboard-operacao-bateubet  (2026-08-26)

## Corpus Check
- 15 files · ~122,776 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 119 nodes · 149 edges · 17 communities (12 shown, 5 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `728cb456`
...
Cohesion: 0.22
Nodes (8): graphify, Identidade visual: migração pra Estratégia de Marca (26/08), Login Google (26/08), QA de preview com login Google (26/08), Redesign de BI (26/08, em andamento por fase), ✅ RESOLVIDO: apagão de dados da TAP (26/08), Safra do Google (26/08), Workflow deste projeto (instrução do Costa, 26/08)
...
## Knowledge Gaps
- **30 isolated node(s):** `ESCOPOS`, `graphify`, `Identidade visual: migração pra Estratégia de Marca (26/08)`, `Login Google (26/08)`, `QA de preview com login Google (26/08)` (+25 more)
...
- **What connects `ESCOPOS`, `graphify`, `Identidade visual: migração pra Estratégia de Marca (26/08)` to the rest of the system?**
